...
class OnGenerateRoutes{
  ...
  static Route<dynamic>? route(RouteSettings setting){
      ...
      switch(name){
        ...
        case PageConst.contactUsersPage:return _materialPageBuilder(const ContactsPage());
        case PageConst.settingsPage: {
          if(args is String){
            return _materialPageBuilder( SettingsPage(uid: args,));
          }else{
            _materialPageBuilder(const ErrorPage());
          }
        }
        ...
        case PageConst.singleChatPage: return _materialPageBuilder(const SingleChatPage());
